...
[![Download](https://img.shields.io/badge/download-macOS%20%2B%20Windows-111?logo=apple&logoColor=white)](https://github.com/nimeshbuilds/chapterone/releases/latest)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/macOS-universal-black?logo=apple)](https://github.com/nimeshbuilds/chapterone/releases/latest)
...
**[Releases and installers](https://github.com/nimeshbuilds/chapterone/releases)**
...
Mac release downloads require Developer ID signing and Apple notarization. **Windows installers in 0.2.1 are unsigned:** Windows may display an Unknown publisher or SmartScreen warning; publisher identity is not verified. The owner approved this exception for this version. The withdrawn 0.2.0 files must not be distributed. Download the verified release assets rather than development CI artifacts. Verify released downloads against `SHA256SUMS.txt` (`shasum -a 256 <file>` on macOS; `Get-FileHash <file> -Algorithm SHA256` in PowerShell).
...
- ⚡ **One-click model presets** — **Fast / Pro / Default** buttons select curated models for your engines. See the [current model catalog](docs/MODELS.md) for presets and availability notes. Custom model IDs are preserved; use the explicit model check when you want to validate one.
