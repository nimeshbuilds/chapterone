...
- All five jobs passed in [native CI run 35421455680](https://github.com/npandeya/bookwriter/actions/runs/35421455680), including installer builds and packaged smoke checks on Intel Mac, Apple Silicon, Windows x64 and Windows ARM64. Follow-up refinements are tested in the [branch's latest CI runs](https://github.com/npandeya/bookwriter/actions/workflows/ci.yml?query=branch%3Arelease-readiness). Validate the exact revision before tagging.
